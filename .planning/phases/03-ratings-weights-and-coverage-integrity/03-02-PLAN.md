...
<objective>
Implement the ratings matrix interaction layer with compact utilitarian UX and UI, explicit missing-data handling, and non-destructive mode switching cues.
